...
const Network = () => {
  ...
  const handleSave = async (e) => {
    ...
    // Prevent save if user doesn't have write permission
    if (!canWrite) {
      alert('You do not have permission to save changes. Read-only users cannot modify settings.');
      return;
    }
          ...
          {loading ? (
            ...
            <div className="p-4">
              <form onSubmit={handleSave} className="space-y-4">
                ...
                {/* VLAN UI removed – LAN + DNS + ARP only */}
