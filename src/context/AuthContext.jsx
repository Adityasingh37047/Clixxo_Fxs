    ...
    try {
      ...
      if (response.response === true) {
        const userData = { 
          ...
          permission: response.data?.permission || response.data?.role || 'admin', // Store permission
          id: response.data?.id,
          pagePermissions: response.data?.pagePermissions || {},
          channelPermissions: response.data?.channelPermissions || {},
          ...response.data 
        };
